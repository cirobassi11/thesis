...
Fa eccezione la variante del modello di Cook-Torrance con normal map (\cref{subsec:impl-pbr-texture}): per campionare le texture e perturbare la normale, richiede tra gli \texttt{Attributes} anche le coordinate UV e la tangente, dai quali si ricavano la tangente e la bitangente in world space (necessarie per costruire la matrice TBN) trasmesse tra i \texttt{Varyings}.
