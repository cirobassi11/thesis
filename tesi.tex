...
\label{sec:hologram}
Questo shader non si basa su un modello di illuminazione fisico, ma combina tre effetti sovrapposti per simulare l'aspetto di un ologramma: \textit{rim lighting}, \textit{striped pattern} e \textit{flicker}.
...
Lo shader hologram (\cref{sec:hologram}) combina rim lighting, striped pattern e flicker, e introduce la trasparenza. La configurazione del pass abilita l'alpha blending, imposta la coda di rendering a \texttt{Transparent} e disabilita la scrittura nel depth buffer:
