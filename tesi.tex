...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/inspector.jpeg}
    \caption{L'inspector di un materiale in Unity: i parametri mostrati corrispondono alle proprietà dichiarate nel blocco \texttt{Properties} dello shader.}
    \label{fig:inspector}
\end{figure}
