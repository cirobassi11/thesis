...
Le tre tecniche di shading si distinguono per il punto in cui viene valutato il modello di illuminazione e per i dati scambiati tra vertex e fragment shader. Il modello di illuminazione rimane comunque indipendente dalla tecnica scelta.
